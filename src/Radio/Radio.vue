...
<template>
  ...
  >
    <button
      class="focus-visible:ring-primary-500 focus-visible:ring-offset-background relative block shrink-0 cursor-[inherit] appearance-none overflow-hidden rounded-full transition-[background-color] focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
    >
      <span
