...
const rootClass = computed(() => {
  return cn(
    'peer data-[state=checked]:bg-primary data-[state=unchecked]:bg-input focus-visible:ring-focus dark:data-[state=unchecked]:bg-input/80 inline-flex h-[1.15rem] w-8 shrink-0 items-center rounded-full border border-transparent shadow-xs transition-all outline-none disabled:cursor-not-allowed disabled:opacity-50',
    props.class
  )
})
</script>
