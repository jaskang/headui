...
defineOptions({ name: 'HNavigationMenu' })
...
<template>
  <NavigationMenuRoot
    ...
    class="relative z-[1] flex w-full flex-col justify-center"
  >
    <NavigationMenuList class="center m-0 flex list-none flex-col rounded-lg border bg-white p-1 shadow-sm">
      <NavigationMenuItem>
        <NavigationMenuTrigger
          class="text-grass11 hover:bg-green3 focus:shadow-green7 group flex items-center justify-between gap-[2px] rounded-[4px] px-3 py-2 text-sm leading-none font-medium outline-none select-none focus:shadow-[0_0_0_2px]"
        >
          Learn
          <Icon
          ...
          <ul class="one m-0 grid list-none gap-x-[10px] p-[22px] sm:w-[500px] sm:grid-cols-[0.75fr_1fr]">
            <li class="row-span-3 grid">
              <NavigationMenuLink as-child>
                <a
                  class="focus:shadow-green7 flex h-full w-full flex-col justify-end rounded-lg bg-stone-900 p-[25px] no-underline outline-none select-none focus:shadow-[0_0_0_2px]"
                  href="/"
                >
                  <img class="w-16" src="https://reka-ui.com/logo.svg" />
                  <div class="mt-4 mb-[7px] text-[18px] leading-[1.2] font-medium text-white">Reka UI</div>
            ...
            <NavigationMenuListItem href="https://lucide.dev/icons/" title="Icons">
      ...
      <NavigationMenuItem>
        <NavigationMenuLink
          class="text-grass11 hover:bg-green3 focus:shadow-green7 block rounded-[4px] px-3 py-2 text-sm leading-none font-medium no-underline outline-none select-none focus:shadow-[0_0_0_2px]"
      ...
      <NavigationMenuIndicator
        class="data-[state=visible]:animate-fadeIn data-[state=hidden]:animate-fadeOut absolute top-full z-[100] mt-[1px] flex h-[10px] w-[--reka-navigation-menu-indicator-size] translate-x-[--reka-navigation-menu-indicator-position] items-end justify-center overflow-hidden transition-[all,transform_250ms_ease] duration-200 data-[state=hidden]:opacity-0"
      >
    ...
    <div class="absolute top-full left-0 flex w-full justify-center perspective-[2000px]">
      <NavigationMenuViewport
        class="data-[state=open]:animate-scaleIn data-[state=closed]:animate-scaleOut relative mt-[10px] h-[var(--reka-navigation-menu-viewport-height)] w-full origin-[top_center] overflow-hidden rounded-xl border bg-white shadow-sm transition-[width,_height] duration-300 sm:w-[var(--reka-navigation-menu-viewport-width)]"
      />
    </div>
  </NavigationMenuRoot>
</template>
